...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2025 at 12:46 PM
...
(2, 'santa_admin', '$2y$10$7Q1xZkA8FJ6X1yGk5s8Xee6F3VY4uW.qM9Bf.y0y6uH6gP1rI0Y1K', 'admin', '2025-12-16 11:44:49');
...
CREATE TABLE `users` (
  ...
  `password_hash` varchar(255) NOT NULL,
  `milk_balance` int(11) DEFAULT 1000,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
